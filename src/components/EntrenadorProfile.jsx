...
      const confirmacion = window.confirm("¿Confirmas que borras este plan de nutrición? Los clientes que lo tuvieran quedarán sin ninguno asignado");
...
      <>
        ...
        {!mostrarModifEntr && (
                ...
                <table>
                <tr><td>Formación:    </td><td> {dataEntr.estudiosEntr}</td></tr>
                <tr><td>Tarifas:      </td><td> {dataEntr.tarifasEntr}</td></tr>
                <tr><td>Ubicación:    </td><td> {dataEntr.ubicacionEntr}</td></tr>
                <tr><td>Fecha de alta:</td><td> {dataEntr.fechaAltaEntr}</td></tr>
                <tr><td>Especialidad: </td><td> {dataEntr.especEntr}</td></tr>
                </table>
